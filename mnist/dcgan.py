...
for i in range(1, num_steps+1):
    ...
    if i % 100 == 0 or i == 1:        
        list_epoch.append(i)
        list_gloss.append(gl)
        list_dloss.append(dl)
...
plt.plot(list_epoch,list_gloss,'r-',label='G_loss')
plt.plot(list_epoch,list_gloss,'b-',label='D_loss')
plt.legend()
f1.show()
f2 = plt.figure(2)
# plt.plot(epoch_list,gloss_list/np.max(gloss_list),'r-',label='G_loss')
# plt.plot(epoch_list,dloss_list/np.max(dloss_list),'r-',label='D_loss')
plt.plot(list_epoch,list_gloss/np.max(list_gloss),'r-',label='G_loss')
plt.plot(list_epoch,list_dloss/np.max(list_dloss),'b-',label='D_loss')
plt.legend()
f2.show()
