...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 12 17:05:27 2018

@author: bdus

https://blog.csdn.net/sunshine_in_moon/article/details/53033431

conda install graphviz和pydot
...
resnet = resnet()
conv_feat = resnet.get_resnet_v1(data_ref)
flow, scale_map = resnet.get_flownet(data, data_ref)
...
#可视化网络
mx.viz.plot_network(conv_feats).view()
#mx.viz.print_summary(mlp).view()
#https://mxnet.incubator.apache.org/api/python/tools/visualization.html?highlight=lot_network#mxnet.visualization.plot_network